...
/**
 * Get a VM instance for an existing OctoTask project iframe.
 */
...
/**
 * Open an existing OctoTask project in a new tab (or in the current window).
 */
...
/**
 * Embeds an existing OctoTask project on the current page.
 *
 * Returns a promise resolving to a VM instance.
 */

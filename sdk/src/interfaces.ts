...
export interface Project {
  ...
  description?: string;
  /**
   * The project’s template name tells OctoTask how to compile and run project files.
   *
  ...
  /**
   * @deprecated Tags are ignored by the OctoTask SDK since v1.5.4
   */
  tags?: string[];
}
...
export interface ProjectOptions {
  ...
  /**
   * Set the origin URL of your OctoTask EE server.
   *
